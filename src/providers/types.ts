...
export interface ICategoryContext {
	...
	deleteSubcategory: (id: number, objId: string, urlImg: string, title: string) => void;
	addSubcategory: (objId: string, urlImg: string, title: string, subCategoryTitle: string, subCategoryImg: string) => void;
